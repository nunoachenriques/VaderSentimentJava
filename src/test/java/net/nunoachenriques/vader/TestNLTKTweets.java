...
public class TestNLTKTweets {
    ...
    /**
     * Due to Floating Point Precision errors results used to differ by 1 e.g.
     * 0.0345 from NLTK might be 0.0344 or 0.0346 when calculated in Java. This
     * was mainly due to rounding off errors. To handle this the difference
     * between two values should not be greater than 1.
     * <p>
